...
import BoardWriteUI from "./CommunityWrite.presenter";
import { CREATE_BOARD, UPDATE_BOARD } from "./CommunityWrite.queries";
import { ICommunityWriteProps, IUpdateCommunityInput } from "./CommunityWrite.types";
import {
  IMutation,
...
import CommunityWritePresenter from "./CommunityWrite.presenter";

const initialInputs = { writer: "", password: "", title: "", contents: "" };
export default function CommunityWriteContainer(props: ICommunityWriteProps) {
  ...
  const onClickUpdate = async () => {
    ...
    const updateBoardInput: IUpdateCommunityInput = {};
